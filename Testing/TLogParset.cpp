...
void TLogParset::TestParseAndCalc_data()
{
    ...
    QTest::newRow("simple") << "GET https://en.wikipedia.org/w/index.php?title=Kirschkuchen&action=edit&section=8"
                           << 5
    ...
    QTest::newRow("from-case") << "ssl1001 129960997 2014-01-21T08:36:33.097 0.426 1.2.3.4 -/200 12324 GET "
